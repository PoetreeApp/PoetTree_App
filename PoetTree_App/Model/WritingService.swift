...
//                        self.writings.append(WritingGet(id: id,title: title, content: content, views: views, likes: likes, hashtags: hashtags, userEmail: email, userName: userName, imageURL: imageURL))
//                        print(self.writings)
//                    }
//                    
//                }
